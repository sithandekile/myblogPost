...
export default function ContactUs() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Simulate API call
    setTimeout(() => {
      // await axios.post(api/contactInfo,formData)
      setShowSuccess(true);
      setFormData({
        name: '',
        email: '',
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 mt-[60px] md:p-8">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="space-y-6 relative">
              ...
              <button
                ...
                className="w-2/5 absolute left-[30%]  bg-sky-800 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center space-x-3"
              >
                {isSubmitting ? (
                  <>
